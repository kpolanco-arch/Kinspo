...
file1 = URI.open('https://kinspo-dev.s3.amazonaws.com/131b747287785ee61e16010ec34f7101.jpeg')
pin7.photo.attach(io: file1, filename: '131b747287785ee61e16010ec34f7101.jpeg')
...
file2 = URI.open('https://kinspo-dev.s3.amazonaws.com/26e4191984ba891215acc3ff2b8e4487.jpeg')
pin8.photo.attach(io: file2, filename: '26e4191984ba891215acc3ff2b8e4487.jpeg')
...
file3 = URI.open('https://kinspo-dev.s3.amazonaws.com/284dfe5917fcbdf5fb23f50b48090c91.jpeg')
pin9.photo.attach(io: file3, filename: '284dfe5917fcbdf5fb23f50b48090c91.jpeg')

pin10 = Pin.create(title: 'KoozArch', creator_id: user4.id, board_id: board2.id, description: "Touched / Untouched - KooZA/rch", image_url: '' )
file4 = URI.open('https://kinspo-dev.s3.amazonaws.com/33fec67b4ad296d1e98f59bc2ef554ed.jpeg')
pin10.photo.attach(io: file4, filename: '33fec67b4ad296d1e98f59bc2ef554ed.jpeg')
...
file5 = URI.open('https://kinspo-dev.s3.amazonaws.com/4ca801b1ffb1190f6b7b4999f20ca1ae.jpeg')
pin11.photo.attach(io: file5, filename: '4ca801b1ffb1190f6b7b4999f20ca1ae.jpeg')
...
file6 = URI.open('https://kinspo-dev.s3.amazonaws.com/672d89be4096e5e4a4e29e3b213258c2.jpeg')
pin12.photo.attach(io: file6, filename: '672d89be4096e5e4a4e29e3b213258c2.jpeg')
...
file7 = URI.open('https://kinspo-dev.s3.amazonaws.com/68cdb78fc1d0045487e47e1b180f4289.jpeg')
pin13.photo.attach(io: file7, filename: '')
...
file8 = URI.open('https://kinspo-dev.s3.amazonaws.com/729fdad857b3f0544f2fd0053effa112.jpeg')
pin14.photo.attach(io: file8, filename:'729fdad857b3f0544f2fd0053effa112.jpeg')
...
file9 = URI.open('https://kinspo-dev.s3.amazonaws.com/783dca0326f5270066480a3f397ef9e5.jpeg')
pin15.photo.attach(io: file9, filename: '783dca0326f5270066480a3f397ef9e5.jpeg')
...
file10 = URI.open('https://kinspo-dev.s3.amazonaws.com/808d6f999bae09a5d94917a8d67aeb46.jpeg')
pin16.photo.attach(io: file10, filename: '808d6f999bae09a5d94917a8d67aeb46.jpeg')
...
file11 = URI.open('https://kinspo-dev.s3.amazonaws.com/88b0eacda3418d7d0feec6fec4f540ed.jpeg')
pin17.photo.attach(io: file11, filename: '88b0eacda3418d7d0feec6fec4f540ed.jpeg')
...
file12 = URI.open('https://kinspo-dev.s3.amazonaws.com/9e20432d75cd9948a4131221a01233f3.jpeg')
pin18.photo.attach(io: file12, filename: '9e20432d75cd9948a4131221a01233f3.jpeg')
...
file13 = URI.open('https://kinspo-dev.s3.amazonaws.com/arch1.jpeg')
pin19.photo.attach(io: file13, filename: 'arch1.jpeg')
...
file14 = URI.open('https://kinspo-dev.s3.amazonaws.com/arch2exterior.jpeg')
pin20.photo.attach(io: file14, filename: 'arch2exterior.jpeg')
...
file15 = URI.open('https://kinspo-dev.s3.amazonaws.com/arch3green.jpeg')
pin21.photo.attach(io: file15, filename: 'arch3green.jpeg')
...
file16 = URI.open('https://kinspo-dev.s3.amazonaws.com/da3bf117e6bb0786e2c1bd04994bcde4.jpeg')
pin22.photo.attach(io: file16, filename: 'da3bf117e6bb0786e2c1bd04994bcde4.jpeg')
...
file17 = URI.open('https://kinspo-dev.s3.amazonaws.com/e22afab71368e988da11fb8a403618d8.jpeg')
pin23.photo.attach(io: file17, filename: 'e22afab71368e988da11fb8a403618d8.jpeg')
...
file18 = URI.open('https://kinspo-dev.s3.amazonaws.com/fd41b1e1fbbb2fb3271368d21d35b7df.jpeg')
pin24.photo.attach(io: file18, filename: 'fd41b1e1fbbb2fb3271368d21d35b7df.jpeg')
