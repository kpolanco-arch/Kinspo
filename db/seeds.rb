...
pin4 = Pin.create(title: 'Carlo Scarpa -- Gipsoteca Canoviana', creator_id: user2.id,  board_id: board2.id,description: ".", image_url: "https://i.pinimg.com/564x/f6/bd/8c/f6bd8c0bd1019faa794ff8a163bf3de0.jpg" )
